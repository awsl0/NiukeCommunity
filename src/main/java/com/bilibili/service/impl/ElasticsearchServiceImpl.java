...
import com.bilibili.mapper.ElasticsearchMapper;
...
public class ElasticsearchServiceImpl implements ElasticsearchService {
    ...
    public Page<DiscussPost> searchDiscussPost(String keyword, int pageNum, int size){
